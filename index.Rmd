...
Ozawa's research focuses on political communication, with a particular emphasis on Latin America. Ozawa primarily uses computational methods and interviews, applying both in mixed-methods research. His computational work involves using R for time series analysis, natural language processing, topic modeling, data visualization, data collection, and general statistical analysis.
